...
public class ScottishCatEntity extends CatEntity implements CustomCatEntity {
    private final CatBehaviorManager behaviorManager;

    public ScottishCatEntity(EntityType<? extends CatEntity> entityType, World world) {
