...
public class PersianCatEntity extends CatEntity implements CustomCatEntity {
    private final CatBehaviorManager behaviorManager;

    public PersianCatEntity(EntityType<? extends CatEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createPersianCatAttributes() {
        return CatEntity.createCatAttributes()
                ...
                .add(EntityAttributes.GENERIC_ARMOR, 1000.0f)
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, 800.0);
    }
